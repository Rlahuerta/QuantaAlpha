...
const phaseConfig = {
  parsing: { icon: Sparkles, label: 'Parse request', color: 'text-blue-400' },
  planning: { icon: Brain, label: 'Plan directions', color: 'text-purple-400' },
  ...
  analyzing: { icon: Brain, label: 'Analyze results', color: 'text-cyan-400' },
